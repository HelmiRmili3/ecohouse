...
class _SignUpScreenClientState extends State<SignUpScreenClient> {
  ...
  bool isLoding = false;
  File? _selectedImage;
  bool passwordAbscure = true;
  bool passwordConfAbscure = true;

  void toggleObscure() {
    setState(() {
      passwordAbscure = !passwordAbscure;
    });
  }

  void toggleConfObscure() {
    setState(() {
      passwordConfAbscure = !passwordConfAbscure;
    });
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (_, passwordObscure, __) {
                      return AppTextFormField(
                        obscureText: passwordConfAbscure,
